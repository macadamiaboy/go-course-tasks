...
const file_tokens_proto_rawDesc = "" +
	...
	"\x05error\x18\x01 \x01(\tR\x05error2\xfb\x01\n" +
	"\fTokenService\x12I\n" +
	"\n" +
	"IssueToken\x12\x1b.token_v1.IssueTokenRequest\x1a\x1c.token_v1.IssueTokenResponse\"\x00\x12R\n" +
	"\rValidateToken\x12\x1e.token_v1.ValidateTokenRequest\x1a\x1f.token_v1.ValidateTokenResponse\"\x00\x12L\n" +
	"\vRevokeToken\x12\x1c.token_v1.RevokeTokenRequest\x1a\x1d.token_v1.RevokeTokenResponse\"\x00B\bZ\x065.6/pbb\x06proto3"
...
var file_tokens_proto_goTypes = []any{
	(*IssueTokenRequest)(nil),     // 0: token_v1.IssueTokenRequest
	(*IssueTokenResponse)(nil),    // 1: token_v1.IssueTokenResponse
	(*ValidateTokenRequest)(nil),  // 2: token_v1.ValidateTokenRequest
	(*ValidateTokenResponse)(nil), // 3: token_v1.ValidateTokenResponse
	(*RevokeTokenRequest)(nil),    // 4: token_v1.RevokeTokenRequest
	(*RevokeTokenResponse)(nil),   // 5: token_v1.RevokeTokenResponse
}
var file_tokens_proto_depIdxs = []int32{
	0, // 0: token_v1.TokenService.IssueToken:input_type -> token_v1.IssueTokenRequest
	2, // 1: token_v1.TokenService.ValidateToken:input_type -> token_v1.ValidateTokenRequest
	4, // 2: token_v1.TokenService.RevokeToken:input_type -> token_v1.RevokeTokenRequest
	1, // 3: token_v1.TokenService.IssueToken:output_type -> token_v1.IssueTokenResponse
	3, // 4: token_v1.TokenService.ValidateToken:output_type -> token_v1.ValidateTokenResponse
	5, // 5: token_v1.TokenService.RevokeToken:output_type -> token_v1.RevokeTokenResponse
